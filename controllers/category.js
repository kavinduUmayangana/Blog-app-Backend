...
const addCategory=async (req,res,next)=>{
    try{
       ...
       res
       .status(200)
       .json({code:200,status:true,message:'Category added successfully'})
    }
    catch(error){
        next(error);
    }
...
res.status(200).json({code:200,status:true,message:'Category deleted succeesfully'})
    }
catch(error){
...
res.status(200).json({code:200,status:true,message:"Get category successfully",date:{category}})
    }
    catch(error){
next(error)
    }
